...
public class EX01 {
	public static void main(String[] args) {
		...
		- DBMS 회사에서 배포 (*****) or Oracle 회사에서 배포
		- Oracle 설치 > 그 안에 같이 배포 > 'ojdbc6.jar'
		
		1. JDBCTest > 'lib' > ojdbc6.jar 위치(복붙)
		2. 프로젝트에서 jar 참조
		...
		*/
		...
		Connection conn = null; // java.sql package사용
		
		//연결 문자열, Connection String > 접속 정보를 적어 놓은 문자열
		...
		try {
			...
			//업무 진행 ~ Query ~
			// *** 항상 conn.isClosed()가 false 떄만 SQL을 처리
