...
<% 
	...
	//System.out.println(pageContext.getRequest() == response);
	...
	//페이지간 데이터 전달하는 방법
	//1. <form> > 불가능 
	//2. QueryString > response.sendRedirect("ex14_pagecontext_2.jsp?num="+num);
	//3. 내장 객체 > 컬렉션 사용 (***)
	...
	//이동할 때 사용중이었던 request, response를 같이 전달한다. (response와 차이점 ***)
