	...
	<main>
		...
		<section>
			...
			<div class="btns">
				...
				<!--
				<input type="button" value="돌아가기" class="btn btn-secondary" onclick="location.href='/toy/board/view.do';">
				돌아가기 > view는 seq가 있어야 동작을 한다. 조심하기 
				-->
			...
			<!-- 수정하는 글 번호 전달 > hidden 태그는 소스보기로 꼭 확인할 것 -->
