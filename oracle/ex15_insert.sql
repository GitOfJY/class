...
/*
    ...
    INSERT
    - DML
    - 테이블에 데이터를 추가하는 명령어(행/레코드/튜플 추가)
...
-- null 조작
insert into tblMemo values (seqMemo.nextVal, '메모', sysdate);        -- 오류
insert into tblMemo values (seqMemo.nextVal, null, '메모', sysdate);

-- default 조작
insert into tblMemo values (seqMemo.nextVal, null, '메모');            -- 오류
insert into tblMemo values (seqMemo.nextVal, null, '메모', default);
...
insert into tblMemoCopy2(seq, name, memo, regdate) values (6, '홍길동', '메모', sysdate);
