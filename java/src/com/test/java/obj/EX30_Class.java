...
public class EX30_Class {
	public static void main(String[] args) {
		...
		// Case 2.
		// - 배열사용
		// - 데이터 저장의 구조 생성 > 관리 수월 > 가독성 향상
		// - 동일한 성질의 데이터 > 동일한 식별자 사용(방번호)
		...
		// - 각 요소의 이름 부여 > 각각의 데이터가 어떤 데이터인지 식별 용이
		// - 요소의 이름이 동일하다.
...
// 2. 조합 부품(블럭 조합) > 새로운 모양 창조 > 참조형(문자열, 배열, 클래스) x 무한종류



// 클래스 선언하기 > 클래스명 > 파스칼 표기법
// class 이름 { 멤버 선언하기(변수, 메소드) > 클래스 멤버 변수}
// 설계도
class Point {
	public int x;
	public int y;
