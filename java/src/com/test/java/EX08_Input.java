...
public class EX08_Input {
	...
	public static void main(String[] args) throws Exception { //예외처리
		...
		//일시 중지 > 블럭 걸렸다. > 사용자가 키보드로 무언가 입력하기를 기다리고 있는 중
...
/*
 ...
 2. 런타임 에러
 	...
 	- 문법에는 오류가 없는데 다른 원인이 발생하는 에러
 	- 예외(Exception)
 	- 난이도 중간 > 발견 중간 > 발견 복불복 > 테스트 > 발견o > 코드 수정 
 											> 발견 x > 조치 x
 	- 게임 출시 > RPG > 소수의 개발자 모든 기능 테스트 > 모든 기능 테스트 불가능 > 클로즈드 알파, 클로즈드 베타 > 오픈 알파, 오픈 베타 > 수정
 ...
 - 에러 메서지 > java.lang.ArithmeticException: / by zero
 - 에러 발생 코드 > System.out.printf("100 / %d = %d\n", num, 100/num);
 - 해결책 > 제수 0을 사용하면 안된다.
        ex.요구사항 : 사용자로부터 숫자 입력 > 연산식 출력
